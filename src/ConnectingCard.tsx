  ...
  return (
    <>
      <div
        ...
        className="grid grid-cols-[1fr_auto] items-center gap-2 px-2 py-1.5 border-b border-gray-200 last:border-b-0 cursor-pointer transition-all rounded-xl bg-blue-50 hover:bg-blue-100"
        style={{
